...
% Fitting three state model to telegraph model 
function endtest_threestate
...
str={'v','la1','la2','gat','bar_v','bar_la','bar_gat','f','H','KL','mean','fano'};
% v:synthesis rate; la1: activation rate; la2: activation rate; gat: inactivation rate
% bar_v: effective synthesis rate; bar_la: effective activation rate; bar_gat: effective inactivation rate
xlswrite('threestate_N100000_10%.xlsx',str,1,'A1');
%%-------------------------------------
clearvars -except zushu

data=xlsread('N100000_threestate_10%.xlsx');%% read synthetic distributions under 625 parameter sets of three state model and 100000 cell samples with 10% extinsic noise on synthesis rate.
...
xlswrite('threestate_N100000_10%.xlsx',print,1,['A',num2str(zushu+1)]);
