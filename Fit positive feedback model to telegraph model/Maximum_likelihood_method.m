...
% Fitting positive feedback model to telegraph model 
function endtest_positive
...
str={'v','la','mu','gat','bar_v','bar_la','bar_gat','f','H','KL','mean','fano'};
% v:synthesis rate; la: activation rate; mu: positive feedback rate; gat: inactivation rate
% bar_v: effective synthesis rate; bar_la: effective activation rate; bar_gat: effective inactivation rate
xlswrite('positive_N100000_10%.xlsx',str,1,'A1');
%%-------------------------------------
clearvars -except zushu

data=xlsread('N100000_positive_10%.xlsx');%% read synthetic distributions under 625 parameter sets of positive feedback model and 100000 cell samples with 10% extinsic noise on synthesis rate.
...
xlswrite('positive_N100000_10%.xlsx',print,1,['A',num2str(zushu+1)]);
